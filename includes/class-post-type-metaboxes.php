 ...
 * @package SSM_Testimonials
 */
class SSM_Testimonials_Metaboxes {

	public function init() {
		add_action( 'add_meta_boxes', array( $this, 'testimonial_meta_boxes' ) );
		add_action( 'save_post', array( $this, 'save_meta_boxes' ),  10, 2 );
	}

	/**
	 * Register the metaboxes to be used for the SSM Testimonials
	 *
	 * @since 0.1.0
	 */
		...
		<table class="form-table">
			...
			<tr>
				<td class="product_rental_meta_box_td" colspan="2">
					<label for="profile_title"><?php _e( 'Title', 'ssm-testimonials' ); ?>
					</label>
				</td>
				<td colspan="4">
					<input type="text" name="profile_title" class="regular-text" value="<?php echo $title; ?>">
					<p class="description"><?php _e( 'E.g. CEO, Sales Lead, Designer', 'ssm-testimonials' ); ?></p>
				</td>
			</tr>

			<tr>
				<td class="product_rental_meta_box_td" colspan="2">
					<label for="profile_linkedin"><?php _e( 'LinkedIn URL', 'ssm-testimonials' ); ?>
					</label>
				</td>
				<td colspan="4">
			...
			<tr>
				<td class="product_rental_meta_box_td" colspan="2">
					<label for="profile_twitter"><?php _e( 'Twitter URL', 'ssm-testimonials' ); ?>
					</label>
				</td>
				<td colspan="4">
			...
			<tr>
				<td class="product_rental_meta_box_td" colspan="2">
					<label for="profile_facebook"><?php _e( 'Facebook URL', 'ssm-testimonials' ); ?>
					</label>
				</td>
				<td colspan="4">
